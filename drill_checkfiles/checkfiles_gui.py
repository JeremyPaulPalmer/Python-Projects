...
def load_gui(self):
    ...
    self.txt_browse1 = tk.Entry(self.master,textvariable=checkfiles_func.browseFiles, width=82)
    ...
    self.btn_browse2 = tk.Button(self.master,width=24,height=2,text='Browse...',command=lambda:checkfiles_func.browseFiles(self))
