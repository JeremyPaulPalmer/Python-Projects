...
def load_gui(self):
    ...
    self.btn_browse1 = tk.Button(self.master,width=24,height=2,text='Select Source:',command=lambda:checkfiles_func.browseFiles(self))
    self.btn_browse1.grid(row=0,column=0,padx=(25,0),pady=(60,0))
    self.btn_browse2 = tk.Button(self.master,width=24,height=2,text='Select Destination:',command=lambda:checkfiles_func.browseFiles2(self))
    self.btn_browse2.grid(row=1,column=0,padx=(25,0),pady=(20,0))
    self.btn_check = tk.Button(self.master,width=24,height=4,text='Transfer Files',command=lambda:checkfiles_func.checkFiles(self))
